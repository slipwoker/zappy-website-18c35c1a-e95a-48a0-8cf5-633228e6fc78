document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatableElements = document.querySelectorAll(
    '[data-animate], .fade-in, .slide-up, .slide-in'
  );
    ...
    const staggerObserver = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          ...
          const staggerDelay = parseFloat(container.dataset.animateStagger) || 0.1;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a856efae-1c17-4d0d-ad68-7ff8016d5c57',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a856efae-1c17-4d0d-ad68-7ff8016d5c57';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '18c35c1a-e95a-48a0-8cf5-633228e6fc78';
